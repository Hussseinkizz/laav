...
const SwipeCard = (props: Props) => {
  ...
  return (
    <div className="relative flex h-[clamp(60vh,65vh,70vh)] w-4/5 flex-col items-center justify-between overflow-hidden rounded-lg shadow shadow-fuchsia-500 md:w-1/4">
